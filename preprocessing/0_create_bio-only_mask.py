...
# INPUTS
# -------------------------------------------------------------------
bio_tif = "/capacity/occr_davin/chari/P2/Jung_PA/BiodiversityOnly/10km/minshort_speciestargetswithPA_esh10km_repruns10_ranked.tif"

# TEMPLATE NETCDF for target grid
template_nc = "/capacity/occr_davin/mguzman/chari_P2_review/data/control_wdpa17_2015_hist.nc"

out_nc = "/capacity/occr_davin/mguzman/chari_P2_review/bio_withPA.nc"
