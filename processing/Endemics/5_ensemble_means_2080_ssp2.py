...
# Note: suffixes to match the "LU_ssp245" files
RUN_TYPES = {
        ...
        for sce in SCENARIOS:
            ...
            for taxa in TAXAS:
                ...
                for sdm in SDMS:
                    ...
                    for gcm in GCMS:
                        # NEW FILENAME FORMAT:
                        # summed_prob_Mammals_GBM_MIROC5_rcp26_2080_LU_ssp245_pa30_bcw.nc
                        fname = f"summed_prob_{taxa}_{current_sdm}_{gcm}_{sce}_{YEAR}_LU_{LU_SSP}_{suffix}.nc"
                ...
                if sdm_results:
                    ...
                    t_out_name = f"{taxa}_{run_name.lower()}_clim_{sce}_LU_{LU_SSP}_{YEAR}.nc"
            ...
            if len(taxa_ensembles) == len(TAXAS):
                ...
                out_name = f"total_richness_{run_name.lower()}_clim_{sce}_LU_{LU_SSP}_{YEAR}.nc"
