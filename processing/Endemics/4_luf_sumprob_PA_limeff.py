...
ssp_map = {"rcp26": "ssp126", "rcp60": "ssp460"}
...
# Logic for Future Scenarios (Endemics Specific Paths)
...
# --- 3. Processing Loops ---
gcm_map = {
    "GFDL-ESM2M": "GFDL.ESM2M", "IPSL-CM5A-LR": "IPSL.CM5A-LR",
...
for sdm in args.model:
    for gcm in args.gcm:
        for taxa in args.taxa:
            # Create endemic whitelist for this specific taxa
            ...
            print(
                f"\nProcessing Endemics: {taxa} | {sdm} | {gcm} | {args.scenario}")
            ...
            print(
                f"FINISHED: {base_name}.nc | Endemics Processed: {processed_count}")

print("\n>> Endemic processing complete.")
