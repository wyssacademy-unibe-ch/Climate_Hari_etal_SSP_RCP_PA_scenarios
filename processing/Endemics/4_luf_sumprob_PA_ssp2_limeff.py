...
ap.add_argument('--type', type=str,
                choices=['baseline', 'climate_only', 'pa30_bio', 'pa30_bcw'], required=True)
args = ap.parse_args()
...
# Load endemic metadata for filtering
...
for sdm in args.model:
    for gcm in args.gcm:
        for taxa in args.taxa:
            # Create endemic whitelist for the current taxa
            ...
            print(
                f"\n ENDEMICS RUN: Climate={args.scen_clim} | LandUse={args.scen_lu} | Taxa={taxa}")
            ...
            for fname in available_files:
                ...
                # --- FILTER: Skip if species is NOT a modeled endemic ---
