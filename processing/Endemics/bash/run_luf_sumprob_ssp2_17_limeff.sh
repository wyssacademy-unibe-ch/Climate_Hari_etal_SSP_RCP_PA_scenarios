...
MODELS=("GAM" "GBM")
PYTHON_SCRIPT="/capacity/occr_davin/mguzman/chari_P2_review/scripts_git/processing/Endemics/Processing/3_luf_sumprob_PA_ssp2_limeff.py"

# --- 2. Logging Setup ---
LOG_DIR="/capacity/occr_davin/mguzman/chari_P2_review/scripts/logs"
mkdir -p "$LOG_DIR"
# Named specifically for this scenario to avoid confusion
LOG_FILE="$LOG_DIR/run_endemics_limeff_17_SSP2_$(date +%F).log"
touch "$LOG_FILE"
