...
BASE_PATH = (
    "/capacity/occr_davin/mguzman/chari_P2_review/Endemics/PA_scenarios/Sumprob_revised"
)
...
def historical_input(
    ...
    filename = (
        f"summed_prob_endemics_{taxon}_{model}_{HIST_GCM}_"
...
def climate_only_input(
    ...
    filename = (
        f"summed_prob_endemics_{taxon}_{model}_{gcm}_"
