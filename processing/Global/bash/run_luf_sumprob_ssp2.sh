...
MODELS=("GAM" "GBM")
PYTHON_SCRIPT="/capacity/occr_davin/mguzman/chari_P2_review/scripts/global/2_luf_sumprob_PA_ssp45.py"

# --- 2. Logging Setup ---
LOG_DIR="/capacity/occr_davin/mguzman/chari_P2_review/scripts/logs"
mkdir -p "$LOG_DIR"
# Named specifically for this scenario to avoid confusion
LOG_FILE="$LOG_DIR/run_biome_bcw_SSP245_$(date +%F).log"
touch "$LOG_FILE"
...
TYPES=("pa30_bio" "pa30_bcw" "baseline")
YEAR="2080"
...
wait
log_msg "\n======================================================="
log_msg "TARGETED BCW RUN COMPLETED: $(date)"
log_msg "======================================================="