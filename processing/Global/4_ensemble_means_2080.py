...
RUN_TYPES = {
    ...
    "Restoration": ("WDPA/Restoration", "rest"),
    "Climate_Only": ("WDPA/Climate_Only", "clim_only"),
    "PA30_Bio": ("PA30_Bio", "pa30_bio"),
    "PA30_BCW": ("PA30_BCW", "pa30_bcw")
}
    ...
    for run_name, (sub_dir, suffix) in RUN_TYPES.items():
        ...
        for sce in SCENARIOS:
            ...
            for taxa in TAXAS:
                ...
                for sdm in SDMS:
                    ...
                    for gcm in GCMS:
                        ...
                        fname = f"summed_prob_{taxa}_{current_sdm}_{gcm}_{sce}_{YEAR}_{suffix}.nc"
                ...
                if sdm_results:
                    ...
                    t_out_name = f"{taxa}_{run_name.lower()}_{sce}_{YEAR}.nc"
            ...
            if len(taxa_ensembles) == len(TAXAS):
                ...
                out_name = f"total_richness_{run_name.lower()}_{sce}_{YEAR}.nc"
